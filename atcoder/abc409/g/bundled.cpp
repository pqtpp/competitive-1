...
#line 4 "/workspaces/competitive/library/math/NTT.hpp"
using namespace std;
...
#line 4 "/workspaces/competitive/library/math/convolution.hpp"
using namespace std;
...
void solve() {
    ...
    vec<mint> ans(n);
    ans[0] = dp[n];
    rep1(i, n-1) ans[i] = ans[0] * p.pow(i) * fac[i] * c[i-1];
